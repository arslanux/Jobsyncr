...
const WorkAuthorizations = ({ handleClose }) => {
    ...
    return (
        ...
        <Box className="modal_card_section">
            ...
            <Box sx={{ mb: 2 }}>
                <Typography variant="body1" className='modal_work_text' sx={{ my: 2 }}>Work Authorizations Countries</Typography>
...
export default WorkAuthorizations